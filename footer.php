...
echo "        <tr class=hide><td height=4% class=misc_items align=right valign=middle scope=row colspan=2>Powered by&nbsp;<a class=footer_links 
            href='http://httpd.apache.org/'>Apache</a>&nbsp;&#177<a class=footer_links href='https://mariadb.org/'>&nbsp;MariaDB</a> 
            &#177";
...
echo "&nbsp;&#8226;<a class=footer_links href='http://jwsimpson.github.io/modern-php-timeclock'>&nbsp;$app_name&nbsp;$app_version</a></td></tr>\n";
echo "      </table>\n";
echo "    </td>\n";
echo "  </tr>\n";
echo "</table>\n";

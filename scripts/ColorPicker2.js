...
// The above line had to be modified just a bit so the text (if any) behind the color chart could not be seen.
// Changed this: CELLSPACING=1
// To this: CELLSPACING=0
...
// The above line had to be modified just a bit so the color chart would not jump, this jumping was due to the a:hover code in ../css/default.css //
// Changed this: <A HREF="#"
// To this: <A style="font-size:10px;text-decoration:none;" HREF="#"

        cp_contents += '<TD BGCOLOR="' + colors[i] + '"><FONT SIZE="-3"><A style="font-size:10px;text-decoration:none;" HREF="#" onClick="' + windowRef + 'ColorPicker_pickColor(\'' + colors[i] + '\',' + windowRef + 'window.popupWindowObjects[' + cp.index + ']);return false;" ' + mo + ' STYLE="text-decoration:none;">&nbsp;&nbsp;&nbsp;</A></FONT></TD>';
...
// The above line had to be modified just a bit so the text (if any) behind the bottom right corner of the color chart could not be seen.
// Changed this: <TD COLSPAN='"+width2+"' ALIGN='CENTER'
// To this:<TD COLSPAN='"+width2+"' BGCOLOR='ffffff' ALIGN='CENTER'

        cp_contents += "<TR><TD COLSPAN='" + width1 + "' BGCOLOR='#ffffff' ID='colorPickerSelectedColor'>&nbsp;</TD><TD COLSPAN='" + width2 + "' BGCOLOR='#ffffff' ALIGN='CENTER' ID='colorPickerSelectedColorValue'>#FFFFFF</TD></TR>";
    }
    cp_contents += "</TABLE>";
    if (windowMode) {

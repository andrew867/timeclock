...
session_start();
if (! isset($_SESSION['application'])) die("Invalid invocation.");	// set in punchclock.php
...
if (! $empfullname) die(error_msg("Unrecognized employee."));	// no employee specified
...
<table align="center" class="table_border" width="100%" border="0" cellpadding="3" cellspacing="0">
  <tr><th class="rightside_heading" nowrap align="left" colspan="3"><img src="<?php echo $TIMECLOCK_URL; ?>/images/icons/lock_edit.png" />&nbsp;&nbsp;&nbsp;Change your password</th></tr>
  <tr><td height="15" colspan="3">&nbsp;</td></tr>
  <tr><th colspan="3" align="left" style="padding-left:32px;"><?php echo $name_header; ?></th></tr>
  <tr><td class="table_rows" height="25" width="20%" style="padding-left:32px;" nowrap>Old Password:</td><td colspan="2" width="80%"
	  style="color:red;font-family:Tahoma;font-size:10px;padding-left:20px;">
	  <input type="password" size="25" maxlength="50" name="old_password" value="" />&nbsp;*</td></tr>
  <tr><td class="table_rows" height="25" width="20%" style="padding-left:32px;" nowrap>New Password:</td><td colspan="2" width="80%"
	  style="color:red;font-family:Tahoma;font-size:10px;padding-left:20px;">
	  <input type="password" size="25" maxlength="50" name="new_password" value="" />&nbsp;*</td></tr>
  <tr><td class="table_rows" height="25" width="20%" style="padding-left:32px;" nowrap>Confirm Password:</td><td colspan="2" width="80%"
	  style="color:red;font-family:Tahoma;font-size:10px;padding-left:20px;">
	  <input type="password" size="25" maxlength="50" name="confirm_password" value="" />&nbsp;*</td></tr>
  <tr><td height="15" colspan="3">&nbsp;</td></tr>
  <tr><td class="table_rows" align="right" colspan="3" style="color:red;font-family:Tahoma;font-size:10px;">*&nbsp;required&nbsp;</td></tr>
</table>
<table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" class="buttons">
  <tr><td width="30"><input type="image" name="submit" value="Next" align="middle" src="<?php echo $TIMECLOCK_URL; ?>/images/buttons/next_button.png" /></td>
      <td><a href="javascript:history.back();" class="nyroModalClose"><img src="<?php echo $TIMECLOCK_URL; ?>/images/buttons/cancel_button.png" border="0" /></a></td></tr>
</table>

...
(function (z, v) {
    ...
    c.fn.extend({attr: function (a, b) {
        ...
        if (a && typeof a === "string" || a === v)for (var b = (a || "").explode(ca),
    ...
    c.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error".explode(" "), function (a, b) {
        c.fn[b] = function (d) {
    ...
    c.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".explode(" "), function (a, b) {
        c.fn[b] = function (d) {

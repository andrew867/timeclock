...
(function (A, w) {
    ...
    c.fn.extend({attr: function (a, b) {
        ...
        if (a && typeof a === "string")for (var b = (a || "").explode(ca), d = 0, f = this.length; d < f; d++) {
            var e = this[d];
        ...
        if (a && typeof a === "string" || a === w)for (var b = (a || "").explode(ca), d = 0, f = this.length; d < f; d++) {
            var e = this[d];
        ...
        return this.each(function () {
            if (d === "string")for (var e, j = 0, i = c(this), o = b, k = a.explode(ca); e = k[j++];) {
                o = f ? o : !i.hasClass(e);
    ...
    c.event = {add: function (a, b, d, f) {
        ...
        return a.result
    }, props: "altKey attrChange attrName bubbles button cancelable charCode clientX clientY ctrlKey currentTarget data detail eventPhase fromElement handler keyCode layerX layerY metaKey newValue offsetX offsetY originalTarget pageX pageY prevValue relatedNode relatedTarget screenX screenY shiftKey srcElement target toElement view wheelDelta which".explode(" "),
        fix: function (a) {
            if (a[G])return a;
            var b = a;
            a = c.Event(b);
    ...
    c.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error".explode(" "),
        function (a, b) {
            c.fn[b] = function (d) {
    ...
    c.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".explode(" "),
        function (a, b) {
            c.fn[b] = function (d) {

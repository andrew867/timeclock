...
<?php if (strlen($PAGE_META) > 0) echo "$PAGE_META\n"; ?>
...
<style type="text/css">
tr.odd { background-color:<?php echo $color1; ?>; }
tr.even { background-color:<?php echo $color2; ?>; }
</style>
<?php if (strlen($PAGE_STYLE) > 0) echo "$PAGE_STYLE\n"; ?>
<script type="text/javascript" src="scripts/jquery-1.4.2.min.js"></script>
<script type="text/javascript" src="scripts/resize_window.js"></script>
<?php if (strlen($PAGE_SCRIPT) > 0) echo "$PAGE_SCRIPT\n"; ?>
</head>
<body<?php if (strlen($PAGE_BODY_ID) > 0) echo " id=\"$PAGE_BODY_ID\""; ?>>
<div class="page">

<?php include 'header_timeclock.php'; ?>

<?php if (strlen($PAGE_CONTENT_HEADER) > 0) echo "$PAGE_CONTENT_HEADER\n"; ?>
<div class="content">
